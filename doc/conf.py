...
# ==============================================================================
extlinks = {
	'issue': ('https://github.com/Paebbels/pyCallBy/issues/%s', 'issue #'),
	'pull':  ('https://github.com/Paebbels/pyCallBy/pull/%s', 'pull request #'),
	'src':   ('https://github.com/Paebbels/pyCallBy/blob/master/pyCallBy/%s?ts=2', None),
